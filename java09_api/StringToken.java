...
public class StringToken {
	public static void main(String[] args) {
		...
		System.out.println("-------------------");
//		data1 == "Hi Hello Hola"
		StringTokenizer st1 = new StringTokenizer(data1);//공백이 구분자
...
//		data2 =="I%!am%!iron%!man";
		...
		System.out.println(st2.nextToken());
		System.out.println(st2.nextToken());
//		System.out.println(st2.nextToken());<-한번 더 추가했을시 에러, NoSuchElementException
	}
}
