...
public class ArrayQuiz_01 {
	public static void main(String[] args) {
		...
		int[] expense = new int[FLOOR+1];//각 총 관리비 + 총 관리비
...
//		}
		...
		System.out.println();
		System.out.println("총 인원은" + people[FLOOR]+"입니다");
		System.out.println("총 관리비는" + expense[FLOOR] +"입니다");
